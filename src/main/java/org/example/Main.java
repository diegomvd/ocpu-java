...
public class Main {
    public static void main(String[] args) throws URISyntaxException, OCPUException {
        OCPURuntimeEnvironment runtime = new OCPURuntimeEnvironment("http://localhost/ocpu");

        String msg = "package=Rsymphony";
        runtime.localPackageFunctionCall("dibepa","base","library", msg, OCPURuntimeEnvironment.InputType.R);
